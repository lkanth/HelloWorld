pipeline 
{
    ...
    environment 
	{
		...
		HCMX_SUB_CANCEL_DELAY_SECONDS = "120"
						...
						{	    
							...
							{											
								...
								if (personIDResCode == 200 && personIDResponse && personIDResponse.trim()) 
								{
									...
									if (USE_PROXY.equalsIgnoreCase("NO") || ((USE_PROXY.equalsIgnoreCase("YES")) && (PROXY_REQUIRES_CREDENTIALS.equalsIgnoreCase("NO"))))
									{
										(depVMResponse, depVMResponseCode) = sh(script: '''set -x;''' + curlCMD + ''' -s -w '\\n%{response_code}' -X POST "''' + HCMX_CREATE_REQUEST_URL + '''" -k -H "Content-Type: application/json" -H "Accept: application/json" -H "Accept: text/plain" --cookie "TENANTID=$HCMX_TENANT_ID;SMAX_AUTH_TOKEN="''' + SMAX_AUTH_TOKEN + '''"" -d '{"entities":[{"entity_type":"Request","properties":{"RequestsOffering":"10205","CreationSource":"CreationSourceEss","RequestedByPerson":"''' + HCMX_PERSON_ID + '''","RequestedForPerson":"''' + HCMX_PERSON_ID + '''","StartDate":''' + epochMilliSeconds + ''',"Description":"<p>''' + HCMX_REQ_DESCRIPTION + '''</p>","RelatedSubscriptionName":"''' + HCMX_SUB_NAME_UNIQUE + '''","RelatedSubscriptionDescription":"<p>''' + HCMX_SUB_DESCRIPTION + '''</p>","UserOptions":"{\\"complexTypeProperties\\":[{\\"properties\\":{\\"DynamicComplexTypeRefName_c\\":\\"Useroption7f84982ffffe4ee087eb1c3037bcde82_c\\",\\"changedUserOptionsForSimulation\\":\\"Property0179570277d944688463ae3ec6d51e3a_c&\\",\\"OptionSet3517bb855e684778940db705b94da682_c\\":{\\"Option24f001dc6cba4a34bdf070169c7ba102_c\\":true},\\"OptionSetfe195aa9526f42e5bb639a93859c4cbb_c\\":{\\"Option39460cf80c2042f8b5123e423014d874_c\\":true},\\"OptionSetb0831d587f514e14bf97b2e7bb5707a3_c\\":{\\"Option48f631f5e9d14fe9ad07e891c51c3d94_c\\":true},\\"Propertyd385f54906924594b19b18f11216a31c_c\\":\\"''' + HCMX_VCENTER_VM_NUM + '''\\",\\"Property97e26afef86f46cc876137a5e7cb314c_c\\":\\"2c9082997b221e28017b222783030004\\",\\"Propertyff061c5735ab46dab99866db4088caa1_c\\":\\"''' + HCMX_VCENTER_DATACENTER + '''\\",\\"Propertyd2f963a7ed6d4a78be5ccdbe0028f627_c\\":\\"''' + HCMX_VCENTER_VM_TEMPLATE + '''\\",\\"Property4ee17f9a95a34c87ad67d2bddc725462_c\\":\\"''' + HCMX_VCENTER_VM_CUSTOMSPEC + '''\\",\\"Propertye50bc2b5577c437ebdc4227d6bf2a878_c\\":\\"''' + HCMX_VCENTER_VMNAME_PREFIX + '''\\",\\"Optionb7f148d9e2e74d71857e5f5b60a62890_c\\":false,\\"Option48f631f5e9d14fe9ad07e891c51c3d94_c\\":true,\\"Property260b7a0dda424a13802e13eeda81bdf6_c\\":\\"''' + HCMX_VCENTER_VM_MEMORY_SIZE_MB + '''\\",\\"Property0179570277d944688463ae3ec6d51e3a_c\\":\\"''' + HCMX_VCENTER_VM_NUM_CPU + '''\\"}}]}","DisplayLabel":"''' + HCMX_REQ_TITLE + '''","PublicScope":"Private"}}],"operation":"CREATE"}' ''', returnStdout: true).trim().tokenize("\n")
									}
									else
									{
										(depVMResponse, depVMResponseCode) = sh(script: '''set -x;''' + curlCMD + ''' --proxy-user $PROXY_USER:$PROXY_USER_PSW -s -w '\\n%{response_code}' -X POST "''' + HCMX_CREATE_REQUEST_URL + '''" -k -H "Content-Type: application/json" -H "Accept: application/json" -H "Accept: text/plain" --cookie "TENANTID=$HCMX_TENANT_ID;SMAX_AUTH_TOKEN="''' + SMAX_AUTH_TOKEN + '''"" -d '{"entities":[{"entity_type":"Request","properties":{"RequestedForPerson":"''' + HCMX_PERSON_ID + '''","StartDate":''' + epochMilliSeconds + ''',"RequestsOffering":"10205","CreationSource":"CreationSourceEss","RequestedByPerson":"''' + HCMX_PERSON_ID + '''","DataDomains":["Public"],"CreateTime":''' + epochMilliSeconds + ''', "UserOptions":"{\\"complexTypeProperties\\":[{\\"properties\\":{\\"DynamicComplexTypeRefName_c\\":\\"Useroption7f84982ffffe4ee087eb1c3037bcde82_c\\",\\"changedUserOptionsForSimulation\\":\\"Property0179570277d944688463ae3ec6d51e3a_c&\",\"OptionSet3517bb855e684778940db705b94da682_c\":{\"Option24f001dc6cba4a34bdf070169c7ba102_c\":true},\"OptionSetfe195aa9526f42e5bb639a93859c4cbb_c\":{\"Option39460cf80c2042f8b5123e423014d874_c\":true},\"OptionSetb0831d587f514e14bf97b2e7bb5707a3_c\\":{\\"Option48f631f5e9d14fe9ad07e891c51c3d94_c\\":true},\\"Propertyd385f54906924594b19b18f11216a31c_c\\":\\"''' + HCMX_VCENTER_VM_NUM + '''\\",\\"Property97e26afef86f46cc876137a5e7cb314c_c\\":\\"2c9082997b221e28017b222783030004\\",\\"Propertyff061c5735ab46dab99866db4088caa1_c\\":\\"''' + HCMX_VCENTER_DATACENTER + '''\\",\\"Propertyd2f963a7ed6d4a78be5ccdbe0028f627_c\\":\\"''' + HCMX_VCENTER_VM_TEMPLATE + '''\\",\\"Property4ee17f9a95a34c87ad67d2bddc725462_c\\":\\"''' + HCMX_VCENTER_VM_CUSTOMSPEC + '''\\",\\"Propertye50bc2b5577c437ebdc4227d6bf2a878_c\\":\\"''' + HCMX_VCENTER_VMNAME_PREFIX + '''\\",\\"Optionb7f148d9e2e74d71857e5f5b60a62890_c\\":false,\\"Option48f631f5e9d14fe9ad07e891c51c3d94_c\\":true,\\"Property260b7a0dda424a13802e13eeda81bdf6_c\\":\\"''' + HCMX_VCENTER_VM_MEMORY_SIZE_MB + '''\\",\\"Property0179570277d944688463ae3ec6d51e3a_c\\":\\"''' + HCMX_VCENTER_VM_NUM_CPU + '''\\"}}]}"   ,"Description":"<p>''' + HCMX_REQ_DESCRIPTION + '''</p>","RelatedSubscriptionName":"''' + HCMX_SUB_NAME_UNIQUE + '''","RelatedSubscriptionDescription":"<p>''' + HCMX_SUB_DESCRIPTION + '''</p>","RequestAttachments":"{\\"complexTypeProperties\\":[]}","DisplayLabel":"''' + HCMX_REQ_TITLE + '''"}}],"operation":"CREATE"}' ''', returnStdout: true).trim().tokenize("\n")
									}
